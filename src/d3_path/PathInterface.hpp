#ifndef D3__PATH__PATH_INTERFACE_HPP
#define D3__PATH__PATH_INTERFACE_HPP
...
/**
    @note: comments & interface methods given from:
    https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/d3-path/index.d.ts
*/
...
public:
     ...
     */
    virtual void moveTo(number_t x, number_t y) = 0;
     ...
     */
    virtual void lineTo(number_t x, number_t y) = 0;
     ...
     */
    virtual void quadraticCurveTo(number_t cpx, number_t cpy, number_t x, number_t y) = 0;
     ...
     * @param y y-Coordinate of point to draw the curve to
     */
    virtual void bezierCurveTo(number_t cpx1, number_t cpy1, number_t cpx2, number_t cpy2, number_t x, number_t y) = 0;
     ...
     */
    virtual void arcTo(number_t x1, number_t y1, number_t x2, number_t y2, number_t radius) = 0;
     ...
     */
    virtual void rect(number_t x, number_t y, number_t w, number_t h) = 0;
...
#endif // D3__PATH__PATH_INTERFACE_HPP
